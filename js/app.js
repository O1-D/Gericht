(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".body-base-slider")) new core(".body-base-slider__slider", {
                ...
                pagination: {
                    el: ".body-base-slider__navigation",
                    clickable: true
                },
                on: {
                    init: function() {
                        const [...navigation] = document.querySelector(".body-base-slider__navigation").children;
                        navigation.forEach(((elem, index) => {
                            elem.innerHTML = `${String(index + 1).padStart(2, "0")}`;
                        }));
                    }
                }
            });
            if (document.querySelector(".block-images")) new core(".swiper2", {
            ...
            if (document.querySelector(".bar-slider__slider")) new core(".swiper", {
                modules: [ Autoplay, Lazy, EffectFade, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
                ...
                pagination: {
                    el: ".body-bar-slider__navigation",
                    clickable: true
                },
                on: {
                    init: function() {
                        const [...navigation] = document.querySelector(".body-bar-slider__navigation").children;
                        navigation.forEach(((elem, index) => {
                            elem.innerHTML = `${String(index + 1).padStart(2, "0")}`;
                        }));
                    }
            ...
            if (document.querySelector(".header-slider__slider")) new core(".swiper3", {
                modules: [ Autoplay, Lazy, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        DynamicAdapt.prototype.init = function() {
            ...
            this.nodes = document.querySelectorAll("[data-adaptive]");
            for (let i = 0; i < this.nodes.length; i++) {
                const node = this.nodes[i];
                const data = node.dataset.adaptive.trim();
        ...
        alignBlocks(".about-section__content");
        alignBlocks(".about-bar__column");
            ...
            if (videoContainer) {
                ...
                videoContainer.addEventListener("click", (function() {
                    if (video.paused) {
                        ...
                        videoContainer.classList.remove("_active");
                        video.pause();
                    }
                }));
            }
        }));
        let dots, script_text, dataNum;
        document.querySelector(".blog__body-block")?.addEventListener("click", (function(e) {
            e.preventDefault();
            if (!e.target.classList.contains("body-blog__link")) return;
            dataNum = e.target.dataset.num;
            dots = document.querySelector(`.dots${dataNum}`);
            script_text = document.querySelector(`.more${dataNum}`);
            if ("none" === dots.style.display) {
                dots.style.display = "inline-block";
                script_text.style.display = "none";
                e.target.textContent = "Read More";
            } else {
                dots.style.display = "none";
                script_text.style.display = "inline";
                e.target.textContent = "Read Less";
            }
        }));
        if (document.querySelector("#map")) {
            const map = L.map("map").setView([ 48.8534, 2.3488 ], 13);
        ...
        const counter2 = function(entries) {
            ...
            startCounterObserver.unobserve(entry);
        };
